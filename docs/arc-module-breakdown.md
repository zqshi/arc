...
>
> **实现状态标注规则**（见 [CONTRIBUTING.md](../CONTRIBUTING.md)）：
> - `[IMPLEMENTED]` — 已在代码中实现
> - `[PLANNED]` — 尚未实现，属于规划中
> - `[DEPRECATED]` — 设计已废弃
...
## M1 项目空间（Project Space）[IMPLEMENTED]

### 当前状态

**已实现。** Project / Version CRUD、项目配置、版本状态流转、项目列表/切换均已完成。项目仪表盘 `[PLANNED]`。
