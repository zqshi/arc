...
> 最后更新: 2026-06-30 (v6.19 已归档: 原生客户端平台扩展 Windows→iOS→鸿蒙, 见 v6.19.0-snapshot.md, 代码 done 端到端 blocked 于用户凭证; v6.20 已激活: LLM 多厂商凭证管理 + 在线探活, 见 v6.20.0-current.md)
