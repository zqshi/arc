  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-2 text-xs">
        <Field label="代码目录" value={content.project_dir} mono />
        <Field label="框架" value={content.framework} />
        <Field label="构建命令" value={content.build_command} mono />
        <Field label="运行命令" value={content.run_command} mono />
        <Field
          label="后端类型"
          value={
            content.has_backend
